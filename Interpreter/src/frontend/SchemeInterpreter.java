...
public class SchemeInterpreter {
	...
	public static String isValidString(String currentToken)
	...
	public static String isValidVar(String currentToken)
											...
											// class
	{
		...
		for (int i = 0; i < currentToken.length(); i++) {
			for (int j = 0; j < validSymbs.length(); j++) {
				if (((currentToken.charAt(0) >= '0' && currentToken.charAt(0) <= '9') && (currentToken
						.charAt(0) != validSymbs.charAt(j)))
						|| ((i > 0) && (!(currentToken.charAt(i) >= '0' && currentToken
								.charAt(i) <= '9') || (currentToken.charAt(i) != validSymbs
								.charAt(j))))) {
...
>>>>>>> f2998e5356320c423967ecf878e3de0d8198fe6d

	// Check the validity of an unsigned integer, this function works
	// flawlessly!
	public static String isValidUnsignedInt(String currentToken)
...
<<<<<<< HEAD
	...
	// Check the validity of a number, this function works flawlessly!
	public static String isValidNumber(String currentToken)
